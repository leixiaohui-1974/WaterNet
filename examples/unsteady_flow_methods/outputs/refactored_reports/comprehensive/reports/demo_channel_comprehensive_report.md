# demo_channel Comprehensive 分析报告

**生成时间**: 2025-10-07 16:20:41

## 🗂️ 基础信息

| 参数名称 | 数值 | 说明 |
|----------|------|------|
| object_id | demo_channel | 工程参数 |
| channel_length | 5000.0 m | 工程参数 |
| channel_slope | 0.0003 (0.3‰) | 工程参数 |
| roughness_coefficient | 0.030 | 工程参数 |
| bottom_width | 15.0 m | 工程参数 |
| side_slope | 2.0 | 工程参数 |
| simulation_method | SAINT_VENANT_FULL | 工程参数 |
| cross_sections_count | 3 | 工程参数 |
...
- **normal_water_level**: 98.50 m
- **storage_capacity**: 104430452 m³
...
- **technical_notes**: 基于SAINT_VENANT_FULL模型的水力计算结果
...
![steady_flow_profile](..\plots\steady_flow_profiles\demo_channel_steady_flow_profile_20251007_162035.svg)
